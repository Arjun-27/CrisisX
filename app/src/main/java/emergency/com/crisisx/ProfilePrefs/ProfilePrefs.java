package emergency.com.crisisx.ProfilePrefs;
...
public class ProfilePrefs {
    ...
    private boolean reg;
    private String name, phone, email, id, pwd, addr, div, post;
    ...
    public String getDiv() {
        this.div = preferences.getString("DIV", null);
        return div;
    }

    public void setDiv(String div) {
        prefEditor.putString("DIV", div);
        prefEditor.commit();
        this.div = div;
    }

    public String getPost() {
        this.post = preferences.getString("POST", null);
        return post;
    }

    public void setPost(String post) {
        prefEditor.putString("POST", post);
        prefEditor.commit();
        this.post = post;
    }
}
